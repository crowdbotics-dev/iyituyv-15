"""
Django settings for iyituyv_15 project.
...
WSGI_APPLICATION = 'iyituyv_15.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "iyituyv_15 API",
    "DESCRIPTION": "API documentation for iyituyv_15 App",
    "VERSION": "v1",
}
